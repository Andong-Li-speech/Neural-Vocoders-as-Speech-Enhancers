...
def get_parser() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--gt_wavdir_or_wavscp",
        type=str,
        default="/data4/liandong/PROJECTS/FreeV/DatasetsScp/LSJ/ljs_audio_text_test_filelist.txt",
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="/data4/liandong/PROJECTS/FreeV/File_Decodes/LJSpeech/APNet2_ori_authors_f0",
...
def main():
    ...
    with open(args.gt_wavdir_or_wavscp) as f:
        ...
        for line in f.readlines():
            cur_filename = line.strip().split('/')[1].split('|')[0]
            gt_files.append(os.path.join(args.raw_wavdir, cur_filename))
