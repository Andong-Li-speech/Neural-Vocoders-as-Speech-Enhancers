...
class ComputeScore:
    ...
    def __call__(self, fpath, sampling_rate, is_personalized_MOS):
        ...
        fs = sampling_rate
        if input_fs != fs:
            audio = librosa.core.resample(aud, orig_sr=input_fs, target_sr=fs)
        else:
            audio = aud
...
if __name__=="__main__":
    ...
    parser.add_argument('-t', "--testset_dir", default='/data4/liandong/PROJECTS/FreeV/File_Decodes/LibriTTS/joint_denoise_vocoder/denoise/2M_steps', 
